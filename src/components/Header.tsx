        ...
        <div className='flex items-center gap-2 md:gap-8 flex-1 min-w-0'>
          ...
          >
            <div className='relative'>
              ...
              />
              <div className='absolute inset-0 rounded-xl bg-linear-to-r from-gradient-primary-subtle/20 to-gradient-secondary-subtle/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
            </div>
            <div className='flex flex-col min-w-0'>
              <span className='font-bold text-lg md:text-xl truncate gradient-text'>Ian Frye</span>
          ...
          <div className='hidden lg:flex items-center gap-2'>
            <Button
              ...
              asChild
            >
              <a href='https://ianfrye.dev'>ianfrye.dev</a>
            </Button>
            <Button
              variant='ghost'
              size='icon'
            ...
            >
              <a
                href='https://github.com/ianfrye0818'
                target='_blank'
              ...
              <DropdownMenuTrigger asChild>
                {name || image ? (
                  <Avatar className='ring-2 ring-border hover:ring-blue-500/50 transition-all duration-300 cursor-pointer'>
                    ...
                    <AvatarFallback className='bg-linear-to-r from-gradient-primary to-gradient-secondary text-white'>
                      {name}
                    </AvatarFallback>
                  </Avatar>
                ) : (
